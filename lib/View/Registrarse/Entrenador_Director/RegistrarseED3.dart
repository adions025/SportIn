...
class RegistrarseED3 extends StatefulWidget { 
  final _id;
  final String _name;
  ...
  RegistrarseED3(this._id,this._name,this._surname,this._email,this._password,this._sexo,this._fecha,this._nacionalidad,this._localiadad);
  @override
  RegistrarseED3State createState() => new RegistrarseED3State(_id,_name,_surname,_email,_password,_sexo,_fecha,_nacionalidad,_localiadad);
}

class RegistrarseED3State extends State<RegistrarseED3> {
  final int _id;
  final String _name;
  final String _surname;
  final String _email;
  ...
  final int _nacionalidad;
  final int _localiadad;
  RegistrarseED3State(this._id,this._name,this._surname,this._email,this._password,this._sexo,this._fecha,this._nacionalidad,this._localiadad);
