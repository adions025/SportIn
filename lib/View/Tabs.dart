        ...
        children: <Widget>[
          ...
          builder: (BuildContext context, AsyncSnapshot<http.Response> response) {
            if (!response.hasData)
              ...
              Friend yo = new Friend(avatar: json[0]['profilePhoto'], name: json[0]['userName'], surname: json[0]['surname'], bio: json[0]['bio'], email: json[0]['email'], location: json[0]['populationName'], 
                                      id: '10', rol: 'jugador', edad: json[0]['birthDate'], sexo:json[0]['sex'], pierna: json[0]['foot'], peso: json[0]['weight'], altura:json[0]['height'],
                                      position: json[0]['playerPositionName'], photoPosition: json[0]['photoPosition'], historial:json[0]['historial'], nacionalidad:json[0]['countryName']);
