...
import 'package:sportin/View/Registrarse/Entrenador_Director/RegistrarseED3.dart';
import 'package:sportin/View/Globals.dart' as globals;

enum SingingCharacter { hombre, mujer }

class RegistrarseED2 extends StatefulWidget {
  final _id;
  final String _name;
  ...
  final List _dias;
  final List _any;
  RegistrarseED2(this._id,this._name,this._surname,this._email,this._password,this._dias,this._any);
  @override
  RegistrarseED2State createState() => new RegistrarseED2State(_id,_name,_surname,_email,_password,_dias,_any);
}

class RegistrarseED2State extends State<RegistrarseED2> {
  ...
  RegistrarseED2State(this._id,this._name,this._surname,this._email,this._password,this._dias,this._any);
  ...
  void _submit() {
    ...
    print('Sexo: ' + _sexo + ' Fecha: ' + _fecha + ' Nacionalidad: ' + _nacionalidad.toString() + ' Localidad: ' +_localiadad.toString());
    Navigator.push(context, new MaterialPageRoute(builder: (BuildContext context) => 
      new RegistrarseED3(_id,_name,_surname,_email,_password,_sexo,_fecha,_nacionalidad,_localiadad)),);
  }
