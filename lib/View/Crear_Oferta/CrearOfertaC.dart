...
class CrearOfertaC extends StatefulWidget {
  final int _searchedRoleId;
  CrearOfertaC(this._searchedRoleId);
  @override
  CrearOfertaCState createState() => new CrearOfertaCState(_searchedRoleId);
}

class CrearOfertaCState extends State<CrearOfertaC> {
  var token = globals.tokenPerUser;
  final int _searchedRoleId;
  CrearOfertaCState(this._searchedRoleId);
              ...
              children: [
                new Column(
                  ...
                  children: <Widget>[
                    ...
                    new Text('En busqueda de club', style: new TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold),),
                    new TextFormField(
