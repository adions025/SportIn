...
class RegistrarseED1 extends StatefulWidget {
  final int _id;
  RegistrarseED1(this._id);
  @override
  _RegistrarseED1State createState() => new _RegistrarseED1State(_id);
}

class _RegistrarseED1State extends State<RegistrarseED1> {
  final scaffoldKey = new GlobalKey<ScaffoldState>();
  final formKey = new GlobalKey<FormState>();
  final int _id;
  _RegistrarseED1State(this._id);
  String _name;
  String _surname;
  String _email;
  String _password;
  ...
  void _performLogin() async{
    ...
    if(status == 'error') {
      ...
      print('Nombre: ' + _name + ' Apellido: ' + _surname + ' Correo: ' + _email + ' Contraseña: ' +_password);
      Navigator.push(context, new MaterialPageRoute(builder: (BuildContext context) => 
        new RegistrarseED2(_id,_name,_surname,_email,_password,_dias,_any)),);
    }
  }
              ...
              children: [
                ...
                new Column(
                  ...
                  children: <Widget>[
                    ...
                    new TextFormField(
                      decoration: new InputDecoration(
                        hintText: "Pep.menendez@gmail.com",
