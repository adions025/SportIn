...
class CrearOfertaD extends StatefulWidget { 
  final int _searchedRoleId;
  CrearOfertaD(this._searchedRoleId);
  @override
  CrearOfertaDState createState() => new CrearOfertaDState(_searchedRoleId);
}

class CrearOfertaDState extends State<CrearOfertaD> {
  var token = globals.tokenPerUser;
  final int _searchedRoleId;
  CrearOfertaDState(this._searchedRoleId);
              ...
              children: [
                new Column(
                  ...
                  children: <Widget>[
                    ...
                    new Text('En busqueda de director', style: new TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold),),
                    new TextFormField(
