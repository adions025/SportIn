            ...
            child: new Container(
              ...
              child: new Column(
                children: <Widget>[
                  new ListTile(
                    onTap: (){
                    Friend friend = new Friend(avatar: _photo[index], name: _nombre[index], surname: data[index]['surname'], bio:data[index]['bio'],  
                                               email: null, location: data[index]['populationName'], id:data[index]['userId'], rol: data[index]['roleId'], 
                    ...
                    print('---------------');
                    print(friend.avatar);
                    Navigator.of(context).push(new MaterialPageRoute(builder: (c) {return new FriendDetailsPage(friend, 'ver', '', avatarTag: 1,);},
              ),
            );},
                    leading: new Hero(
                      tag: index,
